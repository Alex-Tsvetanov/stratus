...
% Числата от борда са генерирани, за да не може изречение да противоречи на таблица.
% Единствената промяна спрямо източника на този файл: двата \input реда по-долу са
% изключени, защото сочат към генерирани файлове, каквито в този проект още няма.
% Когато скриптът за генериране на таблици с измервания заработи, редовете се връщат.
...
\lstset{
    ...
    % \lstinputlisting отказва с „Invalid UTF-8 byte sequence“, защото listings не разбира
